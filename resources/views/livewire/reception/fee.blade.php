<div class="container">
    ...
    <!-- Search Input -->
    <!-- Button to create new Fee -->
    <div class="row mb-2">

        <div class="col-md-6">
            <button wire:click="create" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modal">Add Fees</button>
        </div>
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group mb-1">
                            <label for="fees_type">Fees Type <span class="text-danger fw-300"> *</span></label>
                            <input type="text" wire:model="fees_type" id="fees_type" class="form-control mt-1" placeholder="i.e. Consultation">
        ...
        <table class="table table-bordered mt-5">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ ($fee->employee) ? $fee->employee->name : 'Unknown' }}</td>
                    <td>{{ ($fee->department) ? $fee->department->name : 'Unknown' }}</td>
                    <td>{!! $fee->is_active == 1 ?
